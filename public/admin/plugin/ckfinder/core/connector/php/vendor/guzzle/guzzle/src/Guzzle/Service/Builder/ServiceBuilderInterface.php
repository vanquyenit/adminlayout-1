...
/**
 * Service builder used to store and build frontend or arbitrary data. Client configuration data can be supplied to tell
 * the service builder how to create and cache {@see \Guzzle\Service\ClientInterface} objects. Arbitrary data can be
 * supplied and accessed from a service builder. Arbitrary data and other frontend can be referenced by name in client
 * configuration arrays to make them input for building other frontend (e.g. "{key}").
 */
